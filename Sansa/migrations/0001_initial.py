# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-09 07:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(choices=[('server', '服务器'), ('switch', '交换机'), ('router', '路由器'), ('storage', '存储设备'), ('NLB', 'NetScaler'), ('wireless', '无线AP'), ('software', '软件资产'), ('others', '其它类')], default='server', max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cpu_model', models.CharField(blank=True, max_length=128, verbose_name='CPU类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capactity', models.FloatField(verbose_name='磁盘容量')),
                ('iface_type', models.CharField(choices=[('STAT', 'STAT'), ('SAS', 'SAS'), ('SCSI', 'SCSI'), ('SSD', 'SSD')], max_length=64, verbose_name='接口类型')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('macaddress', models.CharField(blank=True, max_length=64, null=True, unique=True, verbose_name='MAC')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capcity', models.IntegerField(verbose_name='内存大小（MB)')),
                ('memo', models.CharField(blank=True, max_length=128, null=True, verbose_name='备注')),
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('update_date', models.DateTimeField(blank=True, null=True)),
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Sansa.Asset')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('os_type', models.CharField(choices=[('windows', 'Windows'), ('centos', 'CentOS'), ('ubuntu', 'ubuntu')], max_length=32, verbose_name='软件类型')),
                ('distribution', models.CharField(choices=[('linux', 'linux'), ('windows', 'windows'), ('network_firmware', 'network_firmware'), ('software', 'software')], max_length=32, verbose_name='发型版本')),
                ('version', models.CharField(blank=True, max_length=64, null=True, verbose_name='软件/系统版本')),
                ('language', models.CharField(choices=[('cn', '中文'), ('en', '英文')], max_length=32, verbose_name='系统语言')),
            ],
            options={
                'verbose_name': '软件/系统',
        ...
        migrations.AddField(
            model_name='tag',
            name='creater',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Sansa.UserProfile'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='eventlog',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Sansa.UserProfile', verbose_name='事件用户'),
        ),
        migrations.AddField(
            model_name='asset',
            name='admin',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Sansa.UserProfile', verbose_name='资产管理员'),
        ),
        migrations.AddField(
            model_name='asset',
            name='business_unit',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Sansa.BusinessUnit', verbose_name='所属业务'),
        ),
        migrations.AddField(
            model_name='asset',
            name='contract',
